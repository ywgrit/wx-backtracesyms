...
#include "sysdeps/x86/dl-lookupcfg.h"
#include "libc-symbols.h"
#include "sysdeps/unix/sysv/linux/dl-sysdep.h"
#include "sysdeps/i386/dl-fixup-attribute.h"
#include "sysdeps/generic/libc-lock.h"
#include "sysdeps/x86/hp-timing.h"
#include "sysdeps/generic/dl-relocate-ld.h"
#include "libc-symbols.h"
/* #include <tls.h> */
#include "link.h"
#include "list_t.h"
...
/* typedef struct */
/* { */
/*   char *dls_name;		/1* Name of library search path directory.  *1/ */
/*   unsigned int dls_flags;	/1* Indicates where this directory came from. *1/ */
/* } Dl_serpath; */
...
#endif
#include "sysdeps/x86/dl-procruntime.c"
#if !PTHREAD_IN_LIBC
...
extern void _dl_add_to_namespace_list (struct link_map *newwx, Lmid_t nsid)
     attribute_hidden;
...
extern void _dl_show_scope (struct link_map *newwx, int from)
     attribute_hidden;
